...
const bplNo = document.querySelector('#BPL_NO').value;
$.post(`${contextPath}/web/bsisCnsl/trends.do?mId=56`, {"BPL_NO": bplNo},
		(data) => {
...
function gohope() {
	const form_ = document.querySelector("form#hope");
	const actionUrl = `${contextPath}/web/diagnosis/hope.do?mId=54`;
	form_.action = actionUrl;
	form_.submit()
}