...
function deleteCheckedItem() {
	...
	showLoading();
	fetch(`${contextPath}/web/eduDct/delete.do?mId=${mId}`, {
		method: 'POST',
		body: formData
...
function goInput() {
	...
	const actionUrl = `${contextPath}/web/eduDct/input.do?mId=${mId}`;
...
function goView(e) {
	...
	window.location.href = `${contextPath}/web/eduDct/view.do?mId=${mId}&idx=${idx}`;
}
...
function saveEdc() {
	...
	showLoading();
	fetch(`${contextPath}/web/eduDct/insert.do?mId=${mId}`, {
		method: 'POST',
		body: formData
	})
	.then((response) => {
	...
	.then((data) => {
		if(data.INSERT_EDC_RESULT.EDC_INSERT_RESULT > 0) {
			...
			alert(msg);
			window.location.href = `${contextPath}/web/eduDct/list.do?mId=${mId}`;
		} else {
...
function downloadFile(e) {
	...
	const mId = document.querySelector('input[name="mId"]').value;
	window.location.href = `${contextPath}/web/eduDct/download.do?mId=${mId}&idx=${fleIdx}`;
}
...
function openModalForMember(memberIdx) {
	...
	showLoading();
	fetch(`${contextPath}/web/eduDct/getMemberData.do?mId=${mId}`, {
		method: 'POST',
		body: formData
	})
	.then((response) => {
...
function changeStatusAll() {
	...
	showLoading();
	fetch(`${contextPath}/web/eduDct/changeMemberStatusAll.do?mId=${mId}`, {
		method: 'POST',
		body: formData
	})
	.then((response) => {
...
function searchMember() {
	...
	showLoading();
	fetch(`${contextPath}/web/eduDct/member.do?mId=${mId}`, {
		method: 'POST',
		body: formData
	})
	.then((response) => {
...
function registerMember(user) {
	...
	fetch(`${contextPath}/web/eduDct/register.do?mId=${mId}`, {
		method: 'POST',
		body: formData
	})
	.then((response) => {
...
function deleteEdcMember() {
	...
	showLoading();
	fetch(`${contextPath}/web/eduDct/deleteMember.do?mId=${mId}`, {
		method: 'POST',
		body: formData
...
function changeMemberStatus(e) {
	...
	showLoading();
	fetch(`${contextPath}/web/eduDct/changeMemberStatus.do?mId=${mId}`, {
		method: 'POST',
		body: formData
	})
	.then((response) => {
...
function downloadEdcMembers() {
	...
	const actionUrl = `${contextPath}/web/eduDct/downloadEdcMembers.do${queryString}`;
	form.action = actionUrl;
	form.submit();
}
...
function printCertificate(e) {
	...
	const actionUrl = `${contextPath}/web/eduDct/printCertificate.do${queryString}&member=${memberIdx}`;
	form.action = actionUrl;
	form.submit();
}
...
function issueCertificate(e) {
	...
	showLoading();
	fetch(`${contextPath}/web/eduDct/issueCertificate.do?mId=${mId}`, {
		method: 'POST',
		body: formData
	})
	.then((response) => {
...
function uploadExcel(e) {
	...
	showLoading();
	fetch(`${contextPath}/web/eduDct/uploadExcel.do?mId=${mId}`, {
		method: 'POST',
		body: formData
	})
	.then((response) => {
...
function downloadExcel() {
	const queryString = window.location.search;
	window.location.href = `${contextPath}/web/eduDct/downloadExcel.do${queryString}`;
}
