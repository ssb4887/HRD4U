...
function choiceBtn(value1, value2) {
	...
	let html = "";
				html += `	
				<form id="infoForm" name="infoForm" action="${contextPath}/dct/diagnosis/detailView.do?mId=36" method="POST" onsubmit="return validation()" >
				<div>
	                    ...
	                    <div class="basic-search-wrapper">
	                        ...
	                        <div class="one-box">
	                            <dl>
	                                ...
	                                <dd>
	                                    <input type="text" id="modal-textfield04" class="corpPicNm" name="corpPicNm" value="" title="기업담당자 입력" placeholder="기업담당자" size="30" maxlength="30">
	                                </dd>
	                            </dl>
	                        </div>
	                        <div class="one-box">
	                            <dl>
	                                ...
	                                <dd>
	                                    <input type="text" id="modal-textfield05" class="corpPicTel" name="corpPicTel" value="" title="연락처 입력" onkeyup="validation();" placeholder="연락처(000-0000-000)" size="30" maxlength="30">
	                                </dd>
...
bscButtons.forEach(function(bscBtn) {
	bscBtn.addEventListener('click', function(event) {
		...
		const actionUrl = `${contextPath}/`+siteId+`/diagnosis/view.do?mId=54`;
