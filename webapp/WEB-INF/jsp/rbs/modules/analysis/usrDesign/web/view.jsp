				...
				<table class="width-type02">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<itui:objectView itemId="trPeriod" itemInfo="${itemInfo}" objDt="${listDt}" />일
							</td>
							<th scope="row">
								훈련시간
							</th>
							<td>
								<itui:objectView itemId="trtm" itemInfo="${itemInfo}" objDt="${listDt}" />시간
							</td>
							<th scope="row">
								훈련방법
							</th>
						...
						<tr>
							...
							<td>
								<itui:objectView itemId="trneeNm" itemInfo="${itemInfo}" objDt="${listDt}" />
							</td>
						</tr>
						<tr>
							<th scope="row">
		...
		<div class="contents-box pl0">
 		...
 		<div class="btns-area" id="btns-area-1" style="margin-top: 30px;">
 			<div class="btns-right">
	            ...
	            <button type="button" class="btn-m01 btn-color02 depth2" onclick="delOneAnalysis(<c:out value="${dt.RSLT_ANALS_IDX}" />);">
	            	삭제
	            </button>
 			</div>
        </div>
