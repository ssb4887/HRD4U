...
<div class="contents-area">
	...
	<div class="table-type01 horizontal-scroll">
		<table>
			<caption>컨설팅 접수 관리표 : 체크, 번호, 기업명, 사업장관리번호, 소속기관, 구분, 신청일,
				상태, 접수에 관한 정보 제공표</caption>
			<colgroup>
				<col style="width: 6%">
			...
			<thead>
				<tr>
					<th scope="col"><input type="checkbox" id="" name="" value=""
						class="checkbox-type01"></th>
					<th scope="col">번호</th>
			...
			<tbody class="alignC">
				...
				<c:forEach var="listDt" items="${list}" varStatus="i">
					...
					<tr>
						...
						<itui:objectView itemId="corpNm" itemInfo="${itemInfo}"
								objDt="${listDt}"/></td>
						...
						<td>
							<button type="button" class="btn-m02 btn-color03"
								onClick="window.open('/web/consulting/view.do?mId=97&bplNo=${listDt.BPL_NO}&bsiscnslIdx=${listDt.BSISCNSL_IDX}&cnslType=${listDt.CNSL_TYPE}&cnslIdx=${listDt.CNSL_IDX}', '_blank')">
								<span> 상세보기 </span>
							</button>
						</td>
					</tr>
	...
	<div class="paging-navigation-wrapper">
		...
		<p class="paging-navigation">
			...
			<a href="#">3</a> <a href="#">4</a> <a href="#">5</a> <a href="#none"
				class="btn-next">다음 페이지로 이동</a> <a href="#none" class="btn-last">맨
				마지막 페이지로 이동</a>
		</p>
		<!-- //페이징 네비게이션 -->
	</div>
