				...
				<tbody>
					...
					<tr>
						...
						<td class="left" colspan="3"><textarea id="textfield01"
								name="cnslDemandMatter" cols="50" rows="5" class="w100 h100" data-checkValidity="훈련직무 및 개발 요구사항" required><c:out value="${cnsl.cnslDemandMatter}"/></textarea></td>
					</tr>
					<tr>
			...
			<table class="width-type02">
				...
				<tbody>
					...
					<tr>
						...
						<td class="left">
							<input type="text" id="cmptncBrffcNm" name="cmptncBrffcNm" value="${cnsl.cmptncBrffcNm}" class="w100">
					...
					<tr>
						...
						<td class="left"><input type="text" id="cmptncBrffcPicTelno" name="cmptncBrffcPicTelno"
							value="${cnsl.cmptncBrffcPicTelno}" class="w100"></td>
					</tr>
				</tbody>
			</table>
		</div>
			...
			<table class="width-type02" id="teamTable">
				...
				<tbody>
					...
					<tr class="inExpert" id="inExpert_01">
						...
						<td class="" colspan="2">
							<input type="text" id="inExpertId_01_name" name="cnslTeam.members[4].mberName" value="<c:forEach var="member" items="${cnsl.cnslTeam.members}"><c:if test="${member.teamIdx eq 3 and member.teamOrderIdx eq 1}">${member.mberName}</c:if></c:forEach>" class="w100" placeholder="성명" required></td>
						<td class="">
						...
						<td class="left">
							<div class="fileBox">
								<input type="text" id="fileName_01" class="fileName"
									readonly="readonly" placeholder="파일찾기" value="<c:forEach var="file" items="${cnsl.cnslFiles}"><c:if test="${file.itemId eq 'pmFile'}">${file.fileOriginName}</c:if></c:forEach>" data-checkValidity="PM 첨부파일" required> <label
