				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3" class="left">
							<input type="text" id="trOprtnRegionZip" name="trOprtnRegionZip" value="${cnsl.trOprtnRegionZip}" class="w50" placeholder="우편번호 입력" data-checkValidity="우편번호" readOnly required>
							<input type="button" class="btn-m03 btn-color01" onclick="findAddr()"" value="우편번호 찾기">
							<input type="text" id="trOprtnRegionAddr" name="trOprtnRegionAddr" value="${cnsl.trOprtnRegionAddr}" class="w100" placeholder="훈련실시주소" data-checkValidity="실시주소" required readOnly>
					...
					<tr>
						...
						<td class="left">
							<input type="text" id="cmptncBrffcNm"  value="${cnsl.cmptncBrffcNm}" class="w100" data-checkValidity="관할 지부지사" required readOnly>
					...
					<tr>
						...
						<td class="left">
							<input type="text" id="spnt" value="${cnsl.spnt}" class="w100" readOnly>
							<input type="hidden" id="spntNm" name="spntNm" value="${cnsl.spntNm}" class="w100" readOnly></td>
				...
				<tbody>
					...
					<tr>
						...
						<td class="left" colspan="3">
							<textarea id="textfield01" name="cnslDemandMatter" rows="5" class="w100 h100" data-checkValidity="컨설팅 요구사항" required><c:out value="${cnsl.cnslDemandMatter}"/></textarea>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table class="width-type02" id="teamTable">
				...
				<tbody>
					...
					<tr class="exExpert" id="exExpert_01">
						...
						<td class="">
						 <input type="text" id="exExpertId_01_name" name="cnslTeam.members[1].mberName" value="<c:forEach var="member" items="${cnsl.cnslTeam.members}"><c:if test="${member.teamIdx eq 2 and member.teamOrderIdx eq 1}">${member.mberName}</c:if></c:forEach>" class="w100"></td>
						<td class="checkSuitableRadioTd">
