...
<div class="contents-wrapper">
	<!-- CMS 시작 -->
	<form id="${inputFormId}" name="${inputFormId}" method="post" target="submit_target" action="${contextPath}/web/consulting/updateEntrst.do?mId=94<c:out value="${mode}"/>" enctype="multipart/form-data">
                ...
                <div class="one-box">
                    <div class="half-box">
                        <dl>
                            ...
                            <dd>
                                <input type="text" id="id_allwnc" name="allwnc" maxlength="10" title="수당" value="<c:out value="${dt.ALLWNC}" />" class="w100" onkeypress="isNumber();" />
                            </dd>
                        </dl>
                    </div>
                    <div class="half-box">
