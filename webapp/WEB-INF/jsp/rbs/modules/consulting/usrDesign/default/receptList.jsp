		...
		<div class="contents-wrapper">
			...
			<div class="contents-area">
				...
				<div class="table-type01 horizontal-scroll">
					<table>
						<caption>컨설팅 접수 관리표 : 체크, 번호, 기업명, 사업장관리번호, 소속기관, 구분,
							...
							<c:forEach var="listDt" items="${list}" varStatus="i">
								...
								<tr>
									...
									<td><itui:objectView itemId="confmStatus"
											itemInfo="${itemInfo}" objDt="${listDt}" /></td>
									<td>
										<button type="button" class="btn-m02 btn-color03" onClick="window.open('/web/consulting/view.do?mId=97&bplNo=${listDt.BPL_NO}&bsiscnslIdx=${listDt.BSISCNSL_IDX}&cnslType=${listDt.CNSL_TYPE}&cnslIdx=${listDt.CNSL_IDX}', '_blank')">
											<span> 상세보기 </span>
										</button>
									</td>
								</tr>
