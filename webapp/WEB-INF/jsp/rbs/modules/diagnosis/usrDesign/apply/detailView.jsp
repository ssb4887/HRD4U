			...
			<input type="hidden" class="bscIdx" name="bscIdx" value="${bscIdx }" />
                                    ...
                                    <div class="title-wrapper clear">
                                        <p class="word-issue fl">
                                            (발급일자) <fmt:formatDate value="${basket.SYSDATE }" pattern="yyyy-MM-dd"/>
                                        </p>
                                            ...
                                            <table class="width-type02">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        	<fmt:formatDate value='${basket.INSURANCE_DT }' pattern="yyyy-MM-dd"/>
                                                       	</td>
                                                        <th scope="row">
                                                            기업유형
                                                        </th>
                                            ...
                                            <table class="width-type02">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="right" colspan="2"><fmt:formatNumber value="${item.MAX_PAY }" pattern="#,###,###,###,###"/></td>
                                                        <td class="right"><fmt:formatNumber value="${item.TOT_PAY }" pattern="#,###,###,###,###"/></td>
                                ...
                                <div class="contents-area">
                                        ...
                                        <div class="table-type02 horizontal-scroll">
                                            <table class="width-type02">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <c:forEach items="${recommend }" var="item" varStatus="i">
                                                        	<td class="${i.index eq 1 ? 'line' : ''} left">
                                                        		${item.CONSIDERATION }
                                                        		<c:if test="${item.PRTBIZ_NAME eq '기업 자체 훈련 [체계적 현장훈련(S-OJT)]' }">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <c:forEach items="${qrs }" var="item" end="3">
                                                        	<td><a href="${item.url }" target="_blank"><img src="${item.image }" alt="${item.title } QR코드 - 새창열림" class="qrcode" target="_blank"></a></td>
                                                        </c:forEach>
                                                    </tr>
                                                    <tr>
                                                    	<c:forEach items="${qrs }" var="item" end="3">
                                    ...
                                    <div class="btns-area">
                                    	<button type="button" class="btn-b01 round01 btn-color02 left"  onclick="location.href='list.do?mId=54'">
                                    		<span>목록</span>
                                          	<img src="${contextPath}${imgPath}/icon/icon_arrow_right03.png" alt="" class="arrow01" onclick="location.href='list.do?mId=54'"/>
                                       	</button>
                                         <a href="<c:out value="${URL_CLIPREPORT}&bscIdx=${bscIdx }"/>" target="_blank">
                                        	<button type="button" class="btn-b01 round01 btn-color02 left" >
                                        		<span>출력하기</span>
                                        		<img src="${contextPath}${imgPath}/icon/icon_arrow_right03.png" alt="" class="arrow01" onclick="window.open('${pageContext.request.contextPath }/dct/diagnosis/clipReport.do?mId=36&bscIdx=${bscIdx }')"  target="_blank"/>
                                        	</button>
                                       	</a>
                                        <button type="button" class="btn-b01 round01 btn-color03 left btn-qustnr" style="width: 280px" data-bsc="${bscIdx}">
                                            <span>
                                                HRD컨설팅 신청
                                            </span>
                                ...
                                <div class="contents-area">
                                    <div class="btns-area">
                                        <div class="btns-right right">
                                            ...
                                            <form id="hope" method="post" action="hope.do?mId=53">
...
<script src="${contextPath}/web/js/diagnosis/detailView.js"></script>
