...
// 서식 파일 추가
// 개발서버 - %root%\\crf\\diagnosis.crf 운영서버 - %root%/crf/diagnosis.crf >> 변경해서 반영해야 함
OOFFile file = oof.addFile("crf.root", "%root%\\crf\\diagnosis.crf");

// 매개변수 필드 추가 (arg1:매개변수명, arg2:값)
// 기초진단지 IDX 가져오기
String bscIdx = (String) request.getAttribute("BSC_IDX");
...
String fileName = uploadPath + "/diagnosis/report/diagnosis_" + bscIdx + ".pdf";
