	...
	<div class="contents-area">
							...
							<c:forEach var="cnslTeamDt" items="${cnslTeamList}" varStatus="i">
								<c:if test="${cnslTeamDt.TEAM_IDX eq '4'}">
									<tr id="${i.count}" data-type="ex">
										...
										<td><input type="text" name="teamNm${i.count}" class="w100" value="${cnslTeamDt.TEAM_MBER_NAME}"></td>
										<td><input type="text" name="trOprtnDe${i.count}" class="w100" value="${cnslTeamDt.COMPUT_DTLS}"></td>
		...
		<div class="contents-box pl0">
			...
			<div class="btns-right">
				...
				<a href="<c:out value="${DEVELOP_SUPPORT_LIST_FORM_URL}"/>" title="목록" class="btn-m01 btn-color01 depth2 fn_btn_write" onclick="return confirm('목록으로 이동하시겠습니까? \n저장을 하지 않으면 수정한 내용은 저장되지 않습니다.')">목록</a>
			</div>
		</form>
	</div>
</div>
