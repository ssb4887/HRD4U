...
String userAgent = request.getHeader("User-Agent");
String fileName = "맞춤개발_비용신청_목록.xls";
...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
	<table summary="맞춤훈련과정개발 종합 목록을 제공합니다." style="width:100%;">
		<caption>맞춤훈련과정개발 종합 목록</caption>
		<colgroup>
			<col width="500px" />
			<col width="500px" />
			<col width="500px" />
		...
		<tbody>
			...
			<tr>
				...
				<td><c:out value="${listDt.BPL_NM}"></c:out></td>
				<td><c:out value="${listDt.START_YEAR}"></c:out></td>
				<td><c:out value="${listDt.BIZ_TYPE}"></c:out></td>
				<td><c:out value="${listDt.START_YEAR}년 ${listDt.CNSL_TME}회차 맞춤개발"></c:out></td>
				<td><c:out value="${listDt.CNSL_TME}"></c:out></td>
