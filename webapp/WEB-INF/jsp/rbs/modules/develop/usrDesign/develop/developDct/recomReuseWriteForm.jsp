...
<% pageContext.setAttribute("space","\f"); %>
	...
	<div id="cms_board_article" class="contents-wrapper">
		...
		<input type="hidden" value="reuse" name="inputType">
...
<!-- 							</td> -->
	                    ...
	                    <tbody>
	                        ...
	                        <tr>
	                            ...
	                            <td colspan="3" class="left">
									...
									<textarea name="trGoal" id="trGoal" class="w100"><c:out value="${fn:replace(array2,'</p>',newline)}"></c:out></textarea>
	                        ...
	                        <tr>
	                            ...
	                            <td colspan="3" class="left">
									...
									<c:set var="array2" value="${fn:replace(array1,'<p>',space)}"/>
									<textarea name="trSfe" id="trSfe" class="w100"><c:out value="${fn:replace(array2,'</p>',newline)}"></c:out></textarea>
	                            </td>
	                        </tr>
	                        <tr>
	                            ...
	                            <td colspan="3" class="left">
									...
									<c:set var="array2" value="${fn:replace(array1,'<p>',space)}"/>	 	                            
									<textarea name="trnReqm" id="trnReqm" class="w100"><c:out value="${fn:replace(array2,'</p>',newline)}"></c:out></textarea>	                            
	                            </td>
	                        </tr>
	                    </tbody>
	                </table>
		...
		<div class="btns-area">
			<div class="btns-right">
				<button type="submit" class="btn-m01 btn-color03 depth2 fn_btn_submit" data-status="<%= ConfirmProgress.CONSIDERREQUEST.getCode()%>">검토요청</button>
