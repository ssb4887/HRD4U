	                    ...
	                    <tbody>
	                        ...
	                        <tr>
	                            ...
	                            <td colspan="3" class="left">
									...
									<textarea name="trGoal" id="trGoal" class="w100 h200"><c:out value="${fn:replace(array3,'<br>',newline)}"></c:out></textarea>
	                        ...
	                        <tr>
	                            ...
	                            <td colspan="3" class="left">
									...
									<c:set var="array2" value="${fn:replace(array1,'<p>','')}"/>
									<c:set var="array3" value="${fn:replace(array2,'</p>',newline)}"/>
									<textarea name="trSfe" id="trSfe" class="w100 h200"><c:out value="${fn:replace(array3,'<br>',newline)}"></c:out></textarea>
	                            </td>
	                        </tr>
	                        <tr>
	                            ...
	                            <td colspan="3" class="left">
									...
									<c:set var="array2" value="${fn:replace(array1,'<p>','')}"/>
									<c:set var="array3" value="${fn:replace(array2,'</p>',newline)}"/>
									<textarea name="trnReqm" id="trnReqm" class="w100 h200"><c:out value="${fn:replace(array3,'<br>',newline)}"></c:out></textarea>	                            
	                            </td>
	                        </tr>
	                    </tbody>
	                </table>
