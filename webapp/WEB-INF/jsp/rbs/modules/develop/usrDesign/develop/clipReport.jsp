...
// 서식 파일 추가 
// 개발서버 - %root%\\crf\\developReport.crf 운영서버 - %root%/crf/developReport.crf >> 변경해서 반영해야 함
OOFFile file = oof.addFile("crf.root", "%root%\\crf\\developReport.crf");

// 매개변수 필드 추가 (arg1:매개변수명, arg2:값)
// 표준개발 신청서 IDX 가져오기
String devlopIdx = (String) request.getAttribute("DEVLOP_IDX");
//oof.addField("param1", "value");
oof.addField("DEVLOP_IDX", devlopIdx);

// 사업장관리번호 가져오기
String bplNo = (String) request.getAttribute("BPL_NO");
oof.addField("BPL_NO", bplNo);

// 서버에 파일로 저장 할 때
// 저장할 파일 경로 및 이름 지정
// String uploadPath = RbsProperties.getProperty("Globals.upload.file.path");
// String fileName = uploadPath + "/develop/report/develop_" + devlopIdx + ".pdf";
