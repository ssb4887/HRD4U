...
<% pageContext.setAttribute("space","\f"); %>
	...
	<div id="cms_board_article" class="contents-wrapper">
		...
		<div class="fr mb10">
			...
			<a href="#none" class="btn-m01 btn-color01 depth3" id="open-modal01">주치의 지원 (HELP)</a>
		</div>		
	                    ...
	                    <tbody>
	                        ...
	                        <tr>
	                            ...
	                            <td colspan="3" class="left">
									...
									<textarea name="trGoal" id="trGoal" class="w100 h200"><c:out value="${fn:replace(array2,'</p>',newline)}"></c:out></textarea>
	                        ...
	                        <tr>
	                            ...
	                            <td colspan="3" class="left">
									...
									<c:set var="array2" value="${fn:replace(array1,'<p>',space)}"/>
									<textarea name="trSfe" id="trSfe" class="w100 h200"><c:out value="${fn:replace(array2,'</p>',newline)}"></c:out></textarea>
	                            </td>
	                        </tr>
	                        <tr>
	                            ...
	                            <td colspan="3" class="left">
									...
									<c:set var="array2" value="${fn:replace(array1,'<p>',space)}"/>	 	                            
									<textarea name="trnReqm" id="trnReqm" class="w100 h200"><c:out value="${fn:replace(array2,'</p>',newline)}"></c:out></textarea>	                            
	                            </td>
	                        </tr>
	                    </tbody>
	                </table>
