	                    ...
	                    <tbody>
	                        ...
	                        <tr>
	                            ...
	                            <td colspan="3" class="left">
									...
									<c:set var="array3" value="${fn:replace(array2,'</br>',newline)}"/>                   
									<textarea name="trGoal" class="w100 h200"><c:out value="${fn:replace(array3,'</p>',newline)}"></c:out></textarea>
	                        ...
	                        <tr>
	                            ...
	                            <td colspan="3" class="left">
									...
									<c:set var="array2" value="${fn:replace(array1,'<p>',space)}"/>
									<c:set var="array3" value="${fn:replace(array2,'</br>',newline)}"/>
									<textarea name="trSfe" class="w100 h200"><c:out value="${fn:replace(array3,'</p>',newline)}"></c:out></textarea>
	                            </td>
	                        </tr>
	                        <tr>
	                            ...
	                            <td colspan="3" class="left">
									...
									<c:set var="array2" value="${fn:replace(array1,'<p>',space)}"/>	 
									<c:set var="array3" value="${fn:replace(array2,'</br>',newline)}"/>	                            
									<textarea name="trnReqm" class="w100 h200"><c:out value="${fn:replace(array3,'</p>',newline)}"></c:out></textarea>	                            
	                            </td>
	                        </tr>
	                    </tbody>
	                </table>
