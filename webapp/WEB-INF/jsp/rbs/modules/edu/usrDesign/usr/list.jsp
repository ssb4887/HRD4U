...
<div class="loader"></div>
	...
	<div class="contents-wrapper">
		...
		<div class="contents-area02">
			<form action="" method="">
				<input type="hidden" id="mId" name="mId" value="<c:out value='${crtMenu.menu_idx}' />" />
				<fieldset>
								...
								<dl>
									...
									<dd>
										<select id="is_edcStatus" name="is_edcStatus">
											...
											<option value="3">접수대기</option>
											<option value="4">접수종료</option>
										</select>
									</dd>
								</dl>
		...
		<div class="table-type01 horizontal-scroll">
			<table>
				<caption>교육과정 신청표 : 번호, 교육과정명, 소속기관명, 분류, 교육기간, 접수기간, 교육장소, 접수상태, 소속기관, 작성자에 관한 정보 제공표</caption>
				<colgroup>
					<col style="width: 6%">
					<col style="width: 20%">
					<col style="width: 8%">
						...
						<tr>
							...
							<td>
								...
								<a href="javascript:void(0);" class="btn-linked" data-idx="<c:out value='${listDt.EDC_IDX}' />" onclick="goView(event)">
									<img src="${contextPath}${imgePath}/icon/icon_search04.png" alt="" />
								</a>
							</td>
							<td>
							...
							<td>
								<c:out value='${listDt.EDC_CD_NAME}' />
							</td>
							<td>
							...
							<td>
								<c:choose>
									<c:when test="${listDt.RECPT_STATUS eq 2 and listDt.EDC_MY_COUNT < 1}">
										<button type="button" class="btn-m02 btn-color03 w100" data-idx="<c:out value='${listDt.EDC_IDX}' />" data-title="<c:out value='${listDt.EDC_NAME}' />" onclick="registerEdc(event)">
											<span>신청하기</span>
										</button>
									</c:when>
									<c:when test="${listDt.RECPT_STATUS eq 2 and listDt.EDC_MY_COUNT > 0}">
										<span>신청완료</span>
									</c:when>
									<c:when test="${listDt.RECPT_STATUS ne 2}">
