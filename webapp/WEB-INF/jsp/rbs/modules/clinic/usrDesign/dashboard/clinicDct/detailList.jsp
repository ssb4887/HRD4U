...
<c:if test="${!empty TOP_PAGE}">
	<jsp:include page="${TOP_PAGE}" flush="false">
		<jsp:param name="javascript_page" value="${moduleJspRPath}/dashboard/detailList.jsp"/>
...
<div class="contents-wrapper">
	<div class="contents-area">
		...
		<div class="enterprise-board-wrapper depth3">
			<div class="enterprise-board-area2 type02">
				<h2 class="enterprise-board-title">훈련계획 수립</h2>
				<div class="enterprise-board-btn">
					<a href="${contextPath}/${crtSiteId}/clinicDct/plan_view_form.do?mId=67&planIdx=${planProgress[0].PLAN_IDX}&bplNo=${corpInfo.BPL_NO}" class="btn-m02 btn-color03"><span>조회</span></a>
				</div>
				<div class="enterprise-step-wrapper depth3">
					<ul class="enterprise-step-area">
						<li class="progressbar bar01">
							<a <c:if test="${planProgress[0].CONFM_STATUS ge 10 }">class="active" title="훈련계획서가 신청됨"</c:if>>
								<span class="radio-bar" title="신청"></span>
								<p>신청</p>
							</a>
						</li>
						<li class="progressbar bar02">
							<a <c:if test="${planProgress[0].CONFM_STATUS ge 30 }">class="active" title="훈련계획서가 접수됨"</c:if>>
								<span class="radio-bar" title="접수"></span>
								<p>접수</p>
							</a>
						</li>
						<li class="progressbar bar03">
							<a <c:if test="${planProgress[0].CONFM_STATUS ge 55 }">class="active" title="훈련계획서가 승인됨"</c:if>>
			...
			<div class="enterprise-board-area2 type02">
				...
				<div class="enterprise-board-btn">
					<a href="${contextPath}/${crtSiteId}/clinicDct/activity_view_form.do?mId=68" class="btn-m02 btn-color02"><span>일지목록</span></a>
				</div>
			...
			<div class="enterprise-board-area2 type02">
				...
				<div class="enterprise-board-btn">
					<a href="${contextPath}/${crtSiteId}/clinicDct/result_view_form.do?mId=104&resltIdx=${resultProgress[0].RESLT_IDX}&bplNo=${corpInfo.BPL_NO}" class="btn-m02 btn-color03"><span>조회</span></a>
				</div>
				<div class="enterprise-step-wrapper depth3">
					<ul class="enterprise-step-area">
						<li class="progressbar bar01">
							<a <c:if test="${resultProgress[0].CONFM_STATUS ge 10 }">class="active" title="성과보고서가 신청됨"</c:if>>
								<span class="radio-bar" title="신청"></span>
								<p>신청</p>
							</a>
						</li>
						<li class="progressbar bar02">
							<a <c:if test="${resultProgress[0].CONFM_STATUS ge 30 }">class="active" title="성과보고서가 접수됨"</c:if>>
								<span class="radio-bar" title="접수"></span>
								<p>접수</p>
							</a>
						</li>
						<li class="progressbar bar03">
							<a <c:if test="${resultProgress[0].CONFM_STATUS ge 55 }">class="active" title="성과보고서가 승인됨"</c:if>>
								<span class="radio-bar" title="승인"></span>
								<p>승인</p>
							</a>
						</li>
			...
			<div class="enterprise-board-area2 type02">
				...
				<div class="enterprise-board-btn">
					<a href="${contextPath}/${crtSiteId}/clinicDct/support_list_form.do?mId=105&keyField=bplNo&key=${corpInfo.BPL_NO }&is_confmStatus=&is_year=" class="btn-m02 btn-color02"><span>목록</span></a>
				</div>
				<div class="depth3">
					<ul class="enterprise-step-area">
						<li class="progressbar bar01">
