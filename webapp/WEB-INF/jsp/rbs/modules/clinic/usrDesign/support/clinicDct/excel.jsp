...
String userAgent = request.getHeader("User-Agent");
String fileName = "능력개발클리닉_지원금신청서_목록.xls";
...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
	<table summary="능력개발클리닉 지원금신청서 목록을 제공합니다." style="width:100%;">
		<caption>능력개발클리닉 지원금신청서 목록</caption>
		<colgroup>
			<col width="500px" />
			<col width="500px" />
			<col width="500px" />
		...
		<tbody class="alignC">
			...
			<tr>
				...
				<td><fmt:formatDate pattern="yyyy" value="${listDt.REGI_DATE}"/>년 능력개발클리닉 지원금 신청서</td>
