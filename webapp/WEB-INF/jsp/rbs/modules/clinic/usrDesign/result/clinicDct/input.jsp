...
<c:if test="${!empty TOP_PAGE}">
	<jsp:include page="${TOP_PAGE}" flush="false">
		...
		<jsp:param name="javascript_page" value="${moduleJspRPath}/result/input.jsp"/>
...
<div class="contents-wrapper">
	<div class="contents-area">
		...
		<form id="${inputFormId}" name="${inputFormId}" method="post" action="${RESULT_MODIFY_URL}" target="submit_target" enctype="multipart/form-data">
			...
			<div class="contents-box pl0 mt30">
				...
				<div class="table-type02 horizontal-scroll">				
					...
					<table class="width-type02">
						...
						<tbody id="survey">
							<tr>
								<th scope="row" colspan="3">성취도 조사 결과</th>
							</tr>										
							<tr>											
								<th scope="row">구분</th>
								<th scope="row">항목</th>
		...
		<div class="btns-area">
			...
			<div class="btns-right">
				...
				<a href="<c:out value="${RESULT_LIST_FORM_URL}"/>" title="목록으로 이동" class="btn-m01 btn-color01 depth3 fn_btn_cancel" onclick="return confirm('목록으로 이동하시겠습니까? \n저장을 하지 않으면 수정한 내용은 저장되지 않습니다.')">목록</a>
			</div>
		</div>
		</form>
	</div>
