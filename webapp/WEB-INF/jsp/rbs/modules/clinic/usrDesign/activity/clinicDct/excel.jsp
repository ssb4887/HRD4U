...
String userAgent = request.getHeader("User-Agent");
String fileName = "능력개발클리닉_활동일지_목록.xls";
	...
	<table summary="능력개발클리닉 참여 신청서 목록을 제공합니다." style="width:100%;">
		...
		<tbody class="alignC">
			...
			<tr>
				...
				<td><c:out value="${listDt.ACMSLT_ACT_NM}"/></td>
				<td><fmt:formatDate pattern="yyyy" value="${listDt.REGI_DATE}"/>년 능력개발클리닉 활동일지</td>
