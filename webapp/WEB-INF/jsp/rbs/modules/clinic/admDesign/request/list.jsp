...
<c:if test="${!empty TOP_PAGE}">
	...
	<div id="cms_board_article">
		...
		<table class="tbListA" summary="능력개발클리닉 신청 목록을 볼 수 있고 수정 링크를 통해서 수정페이지로 이동합니다.">
			<caption>능력개발클리닉 신청 목록</caption>
			<colgroup>
				<col width="50px" />
				<col width="60px" />
				<col width="60px" />
			...
			<tbody class="alignC">
				...
				<tr>
					...
					<td><itui:objectView itemId="sampleItemId" itemInfo="${itemInfo}" objDt="${listDt}"/></td>
					<td><itui:objectView itemId="sampleItemId" itemInfo="${itemInfo}" objDt="${listDt}"/></td>
					<td><itui:objectView itemId="sampleItemId" itemInfo="${itemInfo}" objDt="${listDt}"/></td>
