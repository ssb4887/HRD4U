			...
			$.ajax({
				...
				data: {
					...
					for(var i = 0; i < activityList.length; i++){
						innerHtml += '<tr><td class="bg01">'+ activityList[i].ESSNTL_SE_NM +'</td>';
						innerHtml += '<td class="bg02">'+ activityList[i].GUBUNNM +'</td>';
						innerHtml += '<td>'+ activityList[i].SPORT_ITEM_NM +'</td>';
						innerHtml += '<td>'+ activityList[i].CONFM_STATUS_NM  +'</td>';
						innerHtml += '<td>'+ activityList[i].YEARLY +'년</td>';
						innerHtml += '<td>'+ activityList[i].ACT_DATE +'</td>';
						innerHtml += '<td>'+ activityList[i].SPRMNY_REQST_YN +'</td>';
						innerHtml += '<td>'+ activityList[i].SPRMNY_PYMNT_YN +'</td></tr>';
					}
