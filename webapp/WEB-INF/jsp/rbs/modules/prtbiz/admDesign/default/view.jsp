	...
	<div id="cms_board_article">
		...
		<table class="tbViewA" summary="${summary}">
			...
			<tbody>
				...
				<tr>
					<itui:itemView itemId="intro" itemInfo="${itemInfo}" colspan="3"/>
				</tr>
				<tr>
		...
		<div class="btnTopFull">
			<div class="right">
				<a href="<c:out value="${URL_MODIFY}"/>&prtbizIdx=${dt.PRTBIZ_IDX}" class="btnTypeA">수정</a>
				<a href="<c:out value="${URL_DELETEPROC}&prtbizIdx=${dt.PRTBIZ_IDX}"/>" title="삭제" class="btnTypeA fn_btn_delete">삭제</a>
				<a href="<c:out value="${URL_LIST}"/>" title="목록" class="btnTypeA fn_btn_write">목록</a>
			</div>
		</div>
		<%@ include file="../training/trainingList.jsp"%>
	</div>
