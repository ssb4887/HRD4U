		...
		<table class="tbListA" summary="<c:out value="${settingInfo.list_title}"/> 목록을 볼 수 있고 수정 링크를 통해서 수정페이지로 이동합니다.">
			...
			<tbody class="alignC">
				...
				<tr>
					...
					<td><a href="${contextPath}/${crtSiteId}/prtbiz/input.do?mId=90&mode=m&tpIdx=${listDt.TP_IDX}" class="btn-m03 btn-color03 fn_btn_modify">수정</a></td>
					<td class="left"><a href="${contextPath}/${crtSiteId}/prtbiz/view.do?mId=90&tpIdx=${listDt.TP_IDX}" class="fn_btn_view"><strong class="title">${listDt.TP_NAME}</strong></a>
						<c:if test="${listDt.REGI_DATE eq now}">
