...
<c:set var="itemObjs" value="${itemInfo.items}"/>
	<div id="cms_board_article" class="contents-wrapper">
		<h3 class="title-type02 h3_textbox">최근 직업훈련 실시 현황 등록</h3>
		<div class="one-box space">
			<div class="half-box half-box-margin">
				...
				<%-- 2. 디자인에 맞게 필요한 항목만 출력하는 경우 --%>
					...
					<table summary="${summary}" id="traing">
						<caption>
						글쓰기 서식
						</caption>
						<colgroup>
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="2">
									<itui:objectYEAR itemId="year" itemInfo="${itemInfo}" objClass="w100 padding10"/>
								</td>
							</tr>
							<tr>
								<th scope="col"><itui:objectItemName itemId="range" itemInfo="${itemInfo}"/></th>
								<th scope="col"><itui:objectItemName itemId="corp" itemInfo="${itemInfo}"/>(개)&nbsp;<strong class="point-important">*</strong></th>
								<th scope="col"><itui:objectItemName itemId="tot" itemInfo="${itemInfo}"/>(명)&nbsp;<strong class="point-important">*</strong></th>
							</tr>
							<tr id="trRange1">
				...
				<div class="btns-area mt60">
					...
					<a href="<c:out value="${URL_LIST}"/>" class="btn-m01 depth3_2 btn-color01">목록</a>
				</div>
				</form>
			</div>
		</div>
