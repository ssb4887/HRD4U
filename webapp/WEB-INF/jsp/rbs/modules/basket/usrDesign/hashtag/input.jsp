...
<c:set var="itemObjs" value="${itemInfo.items}"/>
	<div id="cms_board_article">
		...
		<table class="tbWriteA" summary="${summary}">
			...
			<tbody>
				<tr>
					<itui:itemText itemId="regiName" itemInfo="${itemInfo[regiName]}" colspan="3" objStyle="width:100px"/>
				</tr>
				<tr>
					<itui:itemYMD itemId="resveDate" itemInfo="${itemInfo[resveDate]}" colspan="3" objStyle="width:400px"/>
				</tr>
		...
		<%-- <table class="tbWriteA" summary="${summary}">
			...
			<tbody>
				<tr>
					<itui:itemText itemId="sampleItemId" itemInfo="${itemInfo[regiName]}" colspan="3" objStyle="width:400px"/>
				</tr>
				<tr>
