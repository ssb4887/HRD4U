...
<c:set var="itemInputAll"><itui:itemInputAllMemo itemInfo="${itemInfo}" itemOrderName="${submitType}_order"/></c:set>
...
$("#<c:out value="${inputFormId}"/> .comment-wrapper").html(varSource);
