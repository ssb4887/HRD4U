...
<!-- CMS 시작 -->
	<jsp:include page="../header.jsp" flush="false">
		...
		<jsp:param name="cName" value="main" />
	</jsp:include>
		...
		<div class="enterprise-case-area">
			<div class="enterprise-case-box">
				<div class="enterprise-case-list depth3">
					...
					<div class="case-list-box">
						<p>지원 신청</p>
						<div class="result" id="support-cnt">
					...
					<div class="case-list-box br0">
						<p>처리 임박 업무</p>
						<div class="result">
							<a href="#" id="open-modal02"><strong class="point-color04" id="passed-cnt"><c:out value="${fn:length(delayed) }" /></strong>건</a>
						</div>
					</div>
				</div>
			</div>
