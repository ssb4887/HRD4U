	...
	<div id="cms_calendar_article"> 	
		...
		<table class="tbListA" summary="<c:out value="${settingInfo.list_title}"/> 목록을 볼 수 있고 제목 링크를 통해서 게시물 상세 내용으로 이동합니다.">
			...
			<tbody class="alignC" id="main">
				...
				<tr class="real-item">
					<td class="num">
						<c:out value="${list[0].TOTAL_CONT-listDt.RN+1 }" />
					</td>
					<td class="">
					...
					<td>
						<a href="${contextPath }/web/develop/support_list_form.do?mId=60">
							<c:out value="${confirmProgress.get(listDt.CONFM_STATUS) }" />
						</a>
					</td>
				</tr>
				</c:forEach>
