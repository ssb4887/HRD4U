...
String titleName = "방문기업관리이력_" + formattedDate + "";
...
<body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0">
	<table summary="<%=titleName%> 목록을 제공합니다." style="width:100%;">
		...
		<thead>
			<tr>
				<th scope="col">No</th>
				<th scope="col"><itui:objectItemName itemId="sptjDgnsNm" itemInfo="${itemInfo}"/></th>
				<th scope="col"><itui:objectItemName itemId="bplNm" itemInfo="${itemInfo}"/></th>
				<th scope="col">참조 요구서식</th>
		...
		<tbody class="alignC">
			...
			<c:forEach var="listDt" items="${list}" varStatus="i">
				<tr>
					...
					<td>(<c:out value="${listDt.BPL_NM }"/>)&nbsp;<c:out value="${listDt.SPTJ_NAME }"/></td>
