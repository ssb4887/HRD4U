	...
	<div id="cms_board_article">
		...
		<table class="tbWriteA" summary="${summary}">
			...
			<tbody>
				...
				<tr>
					<itui:itemText itemId="insttName" itemInfo="${itemInfo}" colspan="3" objStyle="width:400px"/>
				</tr>
				<tr>
					<itui:itemText itemId="insttNo" itemInfo="${itemInfo}" colspan="3" objStyle="width:400px"/>
				</tr>
				<tr>
					<itui:itemSelectClass itemId="locCode" itemInfo="${itemInfo}" colspan="3" objStyle="width:400px"/>
				</tr>
				<tr>
					<itui:itemText itemId="phone" itemInfo="${itemInfo}" colspan="3" objStyle="width:400px"/>
				</tr>
				<tr>
					<itui:itemText itemId="homepage" itemInfo="${itemInfo}" colspan="3" objStyle="width:400px"/>
				</tr>
				<tr>
					<itui:itemTextarea itemId="remarks" itemInfo="${itemInfo}" colspan="3" objStyle="width:400px"/>
				</tr>
				<tr>
					<itui:itemText itemId="orderIdx" itemInfo="${itemInfo}" colspan="3" objStyle="width:400px"/>
				</tr>
				<tr>
					<td colspan="4">관할구역</td>
				</tr>
				<itui:itemMultiCheckbox itemId="blockCode" itemInfo="${itemInfo}" colspan="3" objDt="${dt}"/>				
			</tbody>
		</table>
		<div class="btnCenter">
