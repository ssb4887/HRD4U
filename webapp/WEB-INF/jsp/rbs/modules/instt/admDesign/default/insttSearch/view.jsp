	...
	<div id="cms_board_article">
		...
		<table class="tbViewA" summary="${summary}">
			...
			<tbody>
				...
				<tr>
					<itui:itemView itemId="insttName" itemInfo="${itemInfo}" colspan="3"/>
				</tr>
				<tr>
					<itui:itemView itemId="insttNo" itemInfo="${itemInfo}" colspan="3"/>
				</tr>
				<tr>
					<itui:itemView itemId="locCode" itemInfo="${itemInfo}" colspan="3"/>
				</tr>
				<tr>
					<itui:itemView itemId="phone" itemInfo="${itemInfo}" colspan="3"/>
				</tr>
				<tr>
					<itui:itemView itemId="homepage" itemInfo="${itemInfo}" colspan="3"/>
				</tr>
				<tr>
					<itui:itemView itemId="remarks" itemInfo="${itemInfo}" colspan="3"/>
				</tr>
				<tr>
					<itui:itemView itemId="orderIdx" itemInfo="${itemInfo}" colspan="3"/>
				</tr>
				<tr>
					<td colspan="4">관할구역</td>
				</tr>
				<itui:itemViewMultiCheckbox itemId="blockCode" itemInfo="${itemInfo}" objDt="${dt}" colspan="3"/>
			</tbody>
		</table>
		<div class="btnTopFull">
			<div class="right">
				<a href="<c:out value="${URL_MODIFY}"/>&insttIdx=${dt.INSTT_IDX}" class="btnTypeA">수정</a>
				<a href="<c:out value="${URL_DELETEPROC}&insttIdx=${dt.INSTT_IDX}"/>" title="삭제" class="btnTypeA fn_btn_delete">삭제</a>
