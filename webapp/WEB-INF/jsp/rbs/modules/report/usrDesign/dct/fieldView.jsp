...
<div class="contents-wrapper">
	...
	<!-- 							<span class="page-number"> 16 </span> -->
		...
		<!-- CMS 시작 -->
		<form id="${inputFormId}" name="${inputFormId}" method="post" action="${contextPath}/dct/report/inputProc.do?mId=134&mode=m" target="submit_target" enctype="multipart/form-data">
