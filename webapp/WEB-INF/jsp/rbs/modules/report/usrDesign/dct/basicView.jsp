...
<div class="contents-wrapper">
	<!-- CMS 시작 -->
	<form id="${inputFormId}" name="${inputFormId}" method="post" action="${contextPath}/report/inputProc.do?mId=134<c:out value="${modify}"/>" target="submit_target" enctype="multipart/form-data">
...
<div class="fr mt50 exclude-from-print">
	<c:if test="${progress.CONFM_STATUS eq '10'}">
	...
	<c:if test="${progress.CONFM_STATUS eq '50'}">
