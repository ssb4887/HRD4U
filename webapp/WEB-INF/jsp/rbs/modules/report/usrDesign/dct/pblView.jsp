	...
	<div class="contents-area02">
		...
		<form id="report-form">
							...
							<tbody>
								<c:forEach items="${diary }" var="item">
									<tr>
										...
										<td rowspan="3">
											<c:choose>
												<c:when test="${item.EXC_MTH eq '회의' }">
													<span class="point-color04">회의</span> / 워크숍 / FGI
												</c:when>
												<c:when test="${item.EXC_MTH eq '워크숍' }">
													회의 / <span class="point-color04">워크숍</span> / FGI
												</c:when>
												<c:otherwise>
													회의 / 워크숍 / <span class="point-color04">FGI</span>
												</c:otherwise>
											</c:choose>
										</td>
						...
						<table class="width-type02">
							...
							<thead>
								<tr>
									...
									<th scope="col">
										<span class="point-color04">훈련시간</span>
									</th>
									<th scope="col">
										<span class="point-color04">평가방법</span>
									</th>
									<th scope="col">
										<span class="point-color04">훈련 결과물</span>
									</th>
								</tr>
							</thead>
							<tbody>
			...
			<div class="page hidden page-start" id="page3">
				...
				<div class="contents-box">
					<h4 class="title-type02">
						기업 <span class="point-color06">현황</span> 분석
					</h4>
					<h5 class="title-type05">
						가. 기업 경영 이슈
					</h5>
			...
			<div class="page hidden page-start" id="page5">
				...
				<div class="contents-box">
					<h4 class="title-type02">
						기업 훈련<span class="point-color06">환경</span> 분석
					</h4>
					<div class="table-type02 horizontal-scroll">
						<table class="width-type02">
							<colgroup>
							...
							<tbody>
								...
								<tr>
									<th scope="col" class="point-color04">대상자 특성</th>
									<td colspan="4">
					...
					<div class="table-type02 horizontal-scroll">
						<table class="width-type02">
							...
							<thead>
								<tr>
									<th scope="col" colspan="2">구분</th>
									<th scope="col" class="point-color04">역할</th>
			...
			<div class="page hidden page-start" id="page7">
				...
				<div class="contents-box page-start">
					...
					<h5 class="title-type03">만족도 및 성취도 조사</h5>
					<div class="table-type02 horizontal-scroll">
						<table class="width-type02">
							<colgroup>
								<col width="10%">
							...
							<tbody>
								<tr>
									...
									<td colspan="4" class="left">(학습자)</td>
								</tr>
								<tr>
									<th scope="col">과정명</th>
									<td class="left">○○○</td>
								...
								<tr>
									...
									<td><input type="radio" class="radio-type01" id="radio0101" name="radio03" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0102" name="radio03" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0103" name="radio03" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0104" name="radio03" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0105" name="radio03" value=""></td>
								</tr>
								<tr>
									<td class="left">본 훈련과정의 교육방법에 대해 만족하십니까?<br>(이론, 실습, PBL 등)</td>
									<td><input type="radio" class="radio-type01" id="radio0101" name="radio04" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0102" name="radio04" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0103" name="radio04" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0104" name="radio04" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0105" name="radio04" value=""></td>
								</tr>
								<tr>
									<td class="left">본 훈련과정의 교육강사에 대해 만족하십니까?<br>(강사 전문성, 강의 내용 전달능력 등)</td>
									<td><input type="radio" class="radio-type01" id="radio0101" name="radio05" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0102" name="radio05" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0103" name="radio05" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0104" name="radio05" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0105" name="radio05" value=""></td>
								</tr>
								<tr>
									<td class="left">본 훈련과정의 교육시간에 대해 만족하십니까?<br>(교육 내용 대비 시간 부족, 과다 등)</td>
									<td><input type="radio" class="radio-type01" id="radio0101" name="radio06" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0102" name="radio06" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0103" name="radio06" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0104" name="radio06" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0105" name="radio06" value=""></td>
								</tr>
								<tr>
									<td class="left">본 훈련과정의 교육환경에 대해 만족하십니까?<br>(교육 장소, 시설, 장비, 교육자료 등)</td>
									<td><input type="radio" class="radio-type01" id="radio0101" name="radio07" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0102" name="radio07" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0103" name="radio07" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0104" name="radio07" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0105" name="radio07" value=""></td>
								</tr>
								<tr>
									<td rowspan="3">성취도 조사</td>
									<td class="left">본 훈련과정에서 훈련목표로 제시된 지식 및 기술을 습득하였습니까?</td>
									<td><input type="radio" class="radio-type01" id="radio0101" name="radio08" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0102" name="radio08" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0103" name="radio08" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0104" name="radio08" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0105" name="radio08" value=""></td>
								</tr>
								<tr>
									<td class="left">본 훈련과정을 통해 습득한 지식 및 기술을 실무에 적용할 수 있으십니까?</td>
									<td><input type="radio" class="radio-type01" id="radio0101" name="radio09" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0102" name="radio09" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0103" name="radio09" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0104" name="radio09" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0105" name="radio09" value=""></td>
								</tr>
								<tr>
									<td class="left">본 훈련과정을 통해 업무 전문성 및 업무 수행 자신감이 향상되셨습니까?</td>
									<td><input type="radio" class="radio-type01" id="radio0101" name="radio10" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0102" name="radio10" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0103" name="radio10" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0104" name="radio10" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0105" name="radio10" value=""></td>
								</tr>
							</tbody>
						</table>
					</div>
						...
						<table class="width-type02">
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="radio" class="radio-type01" id="radio0101" name="radio11" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0102" name="radio11" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0103" name="radio11" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0104" name="radio11" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0105" name="radio11" value=""></td>
								</tr>
								<tr>
									<td class="left">훈련생은 본 훈련과정에서 습득한 지식 및 기술을 실무에 적용하였습니까?</td>
									<td><input type="radio" class="radio-type01" id="radio0101" name="radio12" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0102" name="radio12" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0103" name="radio12" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0104" name="radio12" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0105" name="radio12" value=""></td>
								</tr>
								<tr>
									<td class="left">본 훈련과정은 훈련생의 업무 수행에 실질적인 도움이 되었습니까?</td>
									<td><input type="radio" class="radio-type01" id="radio0101" name="radio13" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0102" name="radio13" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0103" name="radio13" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0104" name="radio13" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0105" name="radio13" value=""></td>
								</tr>
								<tr>
									<td class="left">본 훈련과정이 경영상 이슈(예. 불량률 감소/매출액 증대 등) 해결에 기여했다고 생각하십니까?</td>
									<td><input type="radio" class="radio-type01" id="radio0101" name="radio14" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0102" name="radio14" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0103" name="radio14" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0104" name="radio14" value=""></td>
									<td><input type="radio" class="radio-type01" id="radio0105" name="radio14" value=""></td>
								</tr>
							</tbody>
						</table>
					</div>
			...
			<div class="page hidden page-start" id="page8">
				...
				<div class="contents-box">
					...
					<h5 class="title-type03">학습활동 수행일지(‘업무(단원)명’ 중심으로 작성)</h5>
					<div class="table-type02 horizontal-scroll">
						<table class="width-type02">
							<colgroup>
								<col width="15%">
				...
				<div class="contents-box">
					<h5 class="title-type03">수행 결과물(‘과제’ 중심으로 제시)</h5>
					<div class="table-type02 horizontal-scroll">
						<table class="width-type02">
							<colgroup>
								<col width="15%">
