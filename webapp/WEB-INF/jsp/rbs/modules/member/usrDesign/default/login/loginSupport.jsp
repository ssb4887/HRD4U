...
<div class="login-wrapper" id="wrapper">
	<div class="login-area">
		 <div class="login-box">
			...
			<form id="loginFrm" name="loginFrm" method="post" action="<c:out value="${URL_LOGINSUPPORTPROC}"/>" target="submit_target">
				<fieldset class="loginForm">
					<legend class="blind">로그인 폼</legend>
					<input type="submit" id="fn_logIn_btn" class="btnLogin" value="로그인SSO"/>
				</fieldset>
			</form>
