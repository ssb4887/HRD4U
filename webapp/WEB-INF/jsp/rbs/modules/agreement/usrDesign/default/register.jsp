	...
	<div class="contents-area">
		...
		<div class="table-type01 horizontal-scroll">
			...
			<table>
				...
				<tbody>
					<tr>
						<td class="field" id="	">${not empty register ? register.AGREM_NO : '-' }<input type="hidden" id="agrem_idx" name="agremIdx" value/> <input type="hidden" id="agrem_no" name="agremNo" value="${not empty register ? register.AGREM_NO : '-' }"/></td>
						...
						<td class="field" id="bpl_no"><span id="bpl_no"></span><input type="hidden" id="bpl_no" name="bplNo" value/></td>
...
function search() {
	...
	xhr.open('POST', '${contextPath}/web/agreement/getBsk.do?mId=52', true);
