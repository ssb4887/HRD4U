...
<c:if test="${!empty TOP_PAGE}">
	<jsp:include page="${TOP_PAGE}" flush="false">
		...
		<jsp:param name="javascript_page" value="${moduleJspRPath}/inputDctConsult.jsp"/>
...
<!-- 내정보 테이블 -->
	...
	<div class="contents-area">
				...
				<table summary="${summary}">
					...
					<tbody>
						...
						<td colspan="3">
							...
							<%-- <itui:objectView itemId="file" itemInfo="${itemInfo}" objDt="${objDt}" defVal="${defVal}" objVal="${objVal}" optnHashMap="${optnHashMap}" downloadUrl="${downloadUrl}" classSplitStr="${classSplitStr}"/> --%>
						</td>
						</tr>
		...
		<c:choose>
			<c:when test="${siteInfo.site_id == 'dct'}">
				<div class="btns-area">
			...
			<c:when test="${siteInfo.site_id == 'web'}">
				<div class="btns-area">
