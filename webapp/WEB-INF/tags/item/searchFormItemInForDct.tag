				...
				<c:if test="${!empty itemSearchOrder}">
					...
					<c:forEach var="itemSearchId" items="${itemSearchOrder}">
						...
						<div class="half-box">
							<dl>
								...
								<dd>
									...
									<select name="${keyFieldInfo.select_name}" id="${keyFieldInfo.select_name}" class="select codeLevel input-width48" title="검색옵션">
									...
									<input type="text" name="${keyFieldInfo.query_name}" id="${keyFieldInfo.query_name}" value="<c:out value="${queryString[keyFieldInfo.query_name]}"/>" class="inputSearchText" title="검색어"/>
									</div>
								</dd>
							</dl>
						</div>
						...
						<c:choose>
							...
							<input type="text" name="${itemKeyId}1" id="${itemKeyId}1" title="${itemKeyName}" placeholder="최소${itemKeyName} 입력" class="fn_currentItem" style="width:50%;ime-mode:disabled;" value="<c:out value="${queryString[value1Name]}"/>"/>
							~
							<input type="text" name="${itemKeyId}2" id="${itemKeyId}2" title="${itemKeyName}" placeholder="최대${itemKeyName} 입력" class="fn_currentItem" style="width:50%;ime-mode:disabled;" value="<c:out value="${queryString[value2Name]}"/>"/>
							</c:when>
							...
							<% /* 년도 */ %>
								...
								<select id="${itemKeyId}" name="${itemKeyId}" class="select" style="${objStyle}" title="${yearObjTitle}">
									<option value="">${objTitle} 선택</option>
							...
							<div class="input-group">		
								<input type="text" id="${itemKeyId}1" name="${itemKeyId}1" title="${titleStart}" class="${objClass}" style="${objStyle}" readonly="readonly"<c:if test="${required == 1}"> required="required"</c:if> value="<c:out value="${objVal}"/>"/>
								<span><button type="button" id="fn_btn_${itemKeyId}1" title="${titleStart}" class="${btnClass}" data-idName="${itemKeyId}1"><c:out value="시작일"/></button></span>
							</div>
							<c:out value="~"/>
							<div class="input-group">		
								<input type="text" id="${itemKeyId}2" name="${itemKeyId}2" title="${titleEnd}" class="${objClass}" style="${objStyle}" readonly="readonly"<c:if test="${required == 1}"> required="required"</c:if> value="<c:out value="${objVal}"/>"/>
								<span><button type="button" id="fn_btn_${itemKeyId}1" title="${titleEnd}" class="${btnClass}" data-idName="${itemKeyId}2"><c:out value="종료일"/></button></span>
							</div>
							</c:when>
							...
							<% /* 3차 select */ %>
								...
								<c:forEach var="levelIdx" begin="1" end="${optMaxLevel}">
									...
									<select id="${itemKeyId}${levelIdx}" name="${itemKeyId}_tmp" title="${itemTitle}" style="${objStyle}" class="select t_select codeLevel <c:if test="${optMaxLevel eq 2}"> w50</c:if>"<c:if test="${required == 1}"> required="required"</c:if>>
