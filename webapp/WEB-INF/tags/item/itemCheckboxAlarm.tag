...
<c:if test="${!empty itemObj}">
	...
	<itui:objectCheckboxAlarm itemId="${itemId}" itemInfo="${itemInfo}" objDt="${objDt}" defVal="${defVal}" objVal="${objVal}" optnHashMap="${optnHashMap}" objOptionStyle="${objOptionStyle}"/>
