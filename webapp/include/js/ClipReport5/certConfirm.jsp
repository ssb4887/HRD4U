...
OOFFile file = oof.addFile("crf.root", "%root%/crf/certConfirm.crf");

oof.addConnectionData("*", "HRDDB");

String nttId = (String)request.getParameter("nttId") == null ? "" : (String)request.getParameter("nttId");
String certNo = (String)request.getParameter("certNo") == null ? "" : (String)request.getParameter("certNo");
String certTimeKeyData = (String)request.getParameter("certTimeKeyData") == null ? "" : (String)request.getParameter("certTimeKeyData");

String linkUrl = "https://www.hrd4u.or.kr/hrdcert/BestHrdCertLink.do?certNo="+certNo+"&certTimeKeyData="+certTimeKeyData;

String url = "localhost:8080/ClipReport5/";

oof.addField("NTTID", nttId);
oof.addField("CERTNO", certNo);
oof.addField("LINKURL", linkUrl);
