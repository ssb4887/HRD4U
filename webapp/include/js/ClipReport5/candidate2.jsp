...
OOFFile file = oof.addFile("crf.root", "%root%/crf/candidateCnt.crf");

oof.addConnectionData("*", "hrddb");

String postSeq = (String)request.getParameter("postSeq") == null ? "" : (String)request.getParameter("postSeq");

String url = "localhost:8080/ClipReport5/";

// parameter 
oof.addField("url","http://" + url + "ClipBarcodeVerify.jsp");
oof.addField("POSTSEQ", postSeq);
