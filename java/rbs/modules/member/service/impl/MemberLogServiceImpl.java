...
import rbs.modules.member.mapper.MemberLogMapper;
...
public class MemberLogServiceImpl extends EgovAbstractServiceImpl implements MemberLogService {

	@Resource(name = "rbsMessageSource")
	RbsMessageSource rbsMessageSource;
	
	@Resource(name="memberLogMapper")
	private MemberLogMapper memberLogDAO;
	/**
     * 전체 목록 수
	 * @param mapFlag
	 * @param param
	...
	public void setEprivacy(Logger logger, String logType, DataMap dt, String changePw, JSONObject items, String memberIdx, String regiIdx, String dbRegiId, String dbRegiName) throws Exception{
		...
		/*searchList.add(new DTForm("USER_NUM", memberIdx));*/
		param.put("searchList", searchList);
		param.put("USER_NUM", memberIdx);
		...
		if(RbsProperties.getPropertyInt("Globals.member.log.use.db") == 1){
