...
import rbs.modules.member.mapper.LoginAnMapper;
 ...
 *  </pre>
 */
@Service("rbsLoginAnService")
public class LoginAnServiceImpl extends EgovAbstractServiceImpl implements LoginAnService {

    @Resource(name="loginAnMapper")
    private LoginAnMapper loginDAO;
